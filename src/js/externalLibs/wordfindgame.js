...
(function(document, $, wordfind) {
  ...
  var getWords = function(wordsList) {
    return wordsList.map((wordEl) => wordEl.toLowerCase()).filter((word) => word);
  };
   ...
   */
  var WordFindGame = function(puzzleEl, options, wordsList) {
    ...
    // Class properties, game initial config:
    wordList = getWords(wordsList).sort();
